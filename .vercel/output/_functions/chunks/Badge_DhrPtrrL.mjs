import { A as AstroError, R as RenderUndefinedEntryError, c as createComponent, u as unescapeHTML, a as renderTemplate, U as UnknownContentCollectionError, f as escape, g as renderUniqueStylesheet, h as renderScriptElement, i as createHeadAndContent, r as renderComponent, b as createAstro, m as maybeRenderHead, d as addAttribute, j as renderSlot } from './astro/server_CCibinO9.mjs';
import { z } from 'zod';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BjW-whgc.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_CALENDLY_URL": "https://calendly.com/moises-muzagrow", "PUBLIC_PLAUSIBLE_DOMAIN": "www.muzagrow.com", "PUBLIC_SITE_URL": "https://www.muzagrow.com", "SITE": "https://www.muzagrow.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DI6gO6_x.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_Dr9JrBQL.mjs');
...
const $$Badge = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Badge;
  const { color = "default", class: className = "" } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<span${addAttribute(["badge", `badge-${color}`, className], "class:list")} data-astro-cid-35zd7xm4> ${renderSlot($$result, $$slots["default"])} </span> `;
}, "C:/Users/crono/Downloads/Muza/muzagrow-v2/src/components/ui/Badge.astro", void 0);
